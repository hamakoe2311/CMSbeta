...
function applyThemeSettings() {
    ...
    document.documentElement.style.setProperty('--user-opacity', appSettings.bgOpacity);
}

// --- Image Resizer for Background ---
...
function setupSettingsModal() {
    ...
    document.getElementById('set-opacity').oninput = (e) => {
        ...
        document.documentElement.style.setProperty('--user-opacity', e.target.value);
    };
